...
public class TankInterface extends JFrame {
    ...
    public List<EnemyTank> enemyTanks = new ArrayList<EnemyTank>();          //敌军坦克
    public NetClient nc = new NetClient();
    TankInterface(){
    ...
    public void launch(){
        ...
        //for(int i=0 ; i<10 ; i++){
         //   enemyTanks.add(new EnemyTank(100+i*80,200,this));
        //}
    ...
    class MyJPanel extends JPanel{
        public void paint(Graphics g) {
            ...
            for(int i=0 ; i<missiles.size() ; i++){                     //画子弹
                ...
                m.hitTanks((ArrayList<EnemyTank>) enemyTanks);
                m.hitTank(myTank);
                m.draw(gOffImage);
            }
